      ...
      (let
        ...
        (pong-world-state
         (make-pong-world 
          ...
          new-ball
          (move-paddle2 (pong-world-left-paddle world) world)
...
(define (move-paddle paddle)
  (make-paddle (make-position 
               ...
               (paddle-dir paddle)
               (paddle-speed paddle)))
(define (move-paddle2 paddle world)
  (make-paddle (make-position 
                 (position-x (paddle-pos paddle))
                 (move-paddle-vert 
                   (- (position-y (ball-pos (pong-world-ball world))) (/ paddle-height 2) ) 
                   (direction-dy (ball-dir (pong-world-ball world))) 
                   (* (direction-dy (ball-dir (pong-world-ball world))) (ball-speed (pong-world-ball world)))))
               (paddle-dir paddle)
               (paddle-speed paddle)))
...
(define (set-left-moving world dir speed)
  (pong-world-set-left-paddle world (set-paddle-moving (pong-world-left-paddle world) (direction-dy (ball-dir (pong-world-ball world))) (* (ball-speed (pong-world-ball world))
                                                                                                                                          (direction-dy (ball-dir (pong-world-ball world)))) )))
